...
public class Ejemplo07 {
    public static void main(String[] args) {
        int operacion;
        String mensajeFinal = "";
        // Se puede hacer un ciclo for dentro de otro ciclo for.
        for (int i = 1; i <= 50; i++) { // for 01
            ...
            for (int contador = 1; contador <= 12; contador++) {
                ...
                // Con es siguiente cambio se presentan las tablas de multiplicar.
                mensajeFinal = String.format("%s%d x %d = %d\n", mensajeFinal,
                        i, contador, operacion);
                
            }
            // System.out.println("\n");
            // La siguiente linea de codigo presenta un salto de linea al terminar la tabla.
